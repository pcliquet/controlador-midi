...
// Botões
#define BUT_PIO_0     PIOC
#define BUT_PIO_ID_0   ID_PIOC
#define BUT_IDX_0      13
...
// 	printf("Inicializando HC05 \n");
	...
	while(1) {
		...
		else if (pio_get(BUT_PIO_1, PIO_INPUT, BUT_IDX_MASK_1) == 0){
			button1 = '1';
		}
		else if (pio_get(BUT_PIO_2, PIO_INPUT, BUT_IDX_MASK_2) == 0){
			button2 = '1';
		}
		else if (pio_get(BUT_PIO_3, PIO_INPUT, BUT_IDX_MASK_3) == 0){
			button3 = '1';
		}
		else if (pio_get(BUT_PIO_4, PIO_INPUT, BUT_IDX_MASK_4) == 0){
			button4 = '1';
		}
		else if (pio_get(BUT_PIO_5, PIO_INPUT, BUT_IDX_MASK_5) == 0){
			button5 = '1';
		}
		else if (pio_get(BUT_PIO_6, PIO_INPUT, BUT_IDX_MASK_6) == 0){
			button6 = '1';
		}
		else if (pio_get(BUT_PIO_7, PIO_INPUT, BUT_IDX_MASK_7) == 0){
			button7 = '1';
		}
		else {
			button0 = '0';
